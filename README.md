...
This will install the necessary packages. Note that you will either need a MOSEK license (free for academic use) or to change the license. You can now play with the [minimal demo](minimal_demo.ipynb).